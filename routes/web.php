...
Route::controller(AdminController::class)->prefix('/admin')->name('admin.')->group(function () {
    ...
    Route::middleware([AdminMiddleware::class])->group(function () {
        ...
        Route::post('/edit/customer', 'editCustomer')->name('editCustomer');
        Route::get('/edit/illustrator/{id}', 'showEditIllustrator')->name('showEditIllustrator');
        Route::post('/edit/illustrator', 'editIllustrator')->name('editIllustrator');
        Route::get('/purchases', 'showPurchases')->name('purchases');
        Route::post('/verify', 'verifyPurchase')->name('verify');
        Route::post('/reject', 'rejectPurchase')->name('reject');
    });
});
